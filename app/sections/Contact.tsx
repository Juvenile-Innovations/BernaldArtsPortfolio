...
const INPUT_FIELDS = [
  ...
  { type: "tel", name: "mobile", label: "Contact Number", placeholder: "Mobile or WhatsApp number" },
  { type: "text", name: "location", label: "Delivery Location", placeholder: "City or Location" },
  { type: "text", name: "size", label: "Dimensions (Sq.ft)", placeholder: "Dimensions (e.g. 10x12)" },
];
          ...
          <div className="lg:col-span-5 text-center lg:text-left">
            <div className="space-y-4">
              <div className="flex items-center justify-center lg:justify-start gap-3 mb-2">
                ...
                <p className={`text-[11px] uppercase tracking-[0.4em] text-rose-500 font-bold ${spaceGrotesk.className}`}>
                  [ COMMISSION BOOKING ]
                </p>
              </div>

              <h2 className={`text-5xl md:text-7xl lg:text-8xl font-black leading-[0.9] tracking-tight uppercase text-white ${spaceGrotesk.className}`}>
                Launch <br />
              ...
              <p className={`text-neutral-400 text-sm max-w-sm mx-auto lg:mx-0 leading-relaxed pt-4 ${spaceGrotesk.className}`}>
                Specify your requirements, select the artistic medium, and define the spatial scale to initiate your custom artwork booking.
              </p>
            </div>
          </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                {activeFields.map((field) => (
                  <div key={field.name} className="flex flex-col gap-1.5">
                    <label className={`text-[10px] md:text-xs uppercase tracking-wider text-neutral-400 font-semibold ${spaceGrotesk.className}`}>
                      {field.label}
                    </label>
                    <input
                      type={field.type}
                ...
                <div className="flex flex-col gap-1.5 relative w-full">
                  ...
                  <motion.select
                    ...
                    animate={highlightField ? {
                      ...
                      borderColor: ["#262626", "#f43f5e", "#f59e0b", "#f43f5e", "#262626"]
                    } : {}}
                  ...
                  >
                    <option value="" className="bg-neutral-950 text-white/50">Select Art Type</option>
                    {ART_TYPES.map((type) => (
