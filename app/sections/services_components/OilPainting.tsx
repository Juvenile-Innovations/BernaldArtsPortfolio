...
const FibonacciIcon = () => (
  <svg viewBox="0 0 100 100" className="w-8 h-8 text-[#d946ef]" fill="none" stroke="currentColor" strokeWidth="1.5">
    <rect x="10" y="10" width="80" height="80" />
    <line x1="60" y1="10" x2="60" y2="90" />
    <line x1="60" y1="60" x2="90" y2="60" />
    <line x1="75" y1="10" x2="75" y2="60" />
    <path d="M10,90 A80,80 0 0,1 90,10" />
    <path d="M90,10 A30,30 0 0,1 60,40" strokeDasharray="2 2" />
  </svg>
);
...
export default function OilPainting() {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      gsap.fromTo(
        ".service-collage-trigger-oil .cursor-pointer",
        { scale: 0.9, opacity: 0, y: 30 },
        {
          ...
          ease: "back.out(1.2)",
          scrollTrigger: {
            trigger: ".service-collage-trigger-oil",
            start: "top 80%",
          }
        }
      );
  ...
  const images = [
    "/images/services/oil_painting_1.png",
    "/images/services/oil_painting_2.png",
    "/images/services/oil_painting_3.png",
    "/images/services/oil_painting_4.png",
  ];
  ...
  return (
    ...
    >
      ...
      <div className="grid lg:grid-cols-12 gap-8 md:gap-12 items-start mb-16 relative z-10 w-full">
        ...
        <div className="service-panel-left lg:col-span-4 flex flex-col gap-4">
          <div className="relative w-full aspect-[16/10] rounded-lg overflow-hidden border border-neutral-900 bg-neutral-950/60">
            {/* Tag overlay */}
            <div className="absolute top-0 left-0 bg-[#d946ef] text-black px-2.5 py-1 font-bold text-xs z-20">
              05
            </div>
            ...
            {/* Bottom label */}
            <div className={`absolute bottom-0 left-0 right-0 bg-black/85 text-[8px] text-[#d946ef] font-mono px-3 py-1 flex items-center justify-between border-t border-neutral-900 z-10 ${shareTechMono.className}`}>
              <span>&lt; OLEO_ACTIVE &gt;</span>
              <span>SYS_OK</span>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between gap-6">
            <div className="flex-1 space-y-1.5">
              <div className="flex items-center gap-3">
                <span className={`px-2 py-0.5 text-[8px] font-bold text-black bg-[#d946ef] uppercase tracking-wider rounded ${shareTechMono.className}`}>
                  SUBSTRATE
                </span>
                <span className={`text-[10px] text-neutral-400 font-mono tracking-wider ${shareTechMono.className}`}>
                  LINEN PANEL / WOODEN SUBSTRATE
                </span>
              </div>
              <div className="flex items-center gap-3">
                <span className={`px-2 py-0.5 text-[8px] font-bold text-black bg-[#d946ef] uppercase tracking-wider rounded ${shareTechMono.className}`}>
        ...
        >
          <h3 className={`text-4xl md:text-6xl font-black uppercase tracking-tight text-white ${spaceGrotesk.className}`}>
            Oil <span className={`${elsie.className} text-[#d946ef] lowercase tracking-normal font-normal px-1`}>painting</span>
          </h3>

          <div className={`text-xs md:text-sm font-bold text-[#d946ef] uppercase tracking-widest mt-1 ${shareTechMono.className}`}>
            TRANSLUCENT GLAZES & CHROMATIC STABILIZATION
          </div>
          ...
          <div className={`flex items-center gap-2 text-[10px] text-neutral-800 tracking-wider font-mono select-none my-4 w-full overflow-hidden ${shareTechMono.className}`}>
            ...
            <span className="text-[#d946ef] flex-shrink-0">+</span>
          </div>
          ...
          <div className="grid md:grid-cols-12 gap-6 items-center">
            ...
            <div className="md:col-span-4 flex w-full justify-center md:justify-end">
              <a
                href="#contact"
                onClick={() => {
                  window.dispatchEvent(new CustomEvent("select-art-type", { detail: "Oil Painting" }));
                }}
                className={`group w-full md:max-w-[200px] py-4 rounded-full border-2 border-[#d946ef] text-center text-xs font-bold uppercase tracking-[0.2em] transition-all duration-300 hover:bg-[#d946ef]/10 text-[#d946ef] hover:text-white ${shareTechMono.className}`}
              >
                Learn More
              </a>
            </div>
      ...
      <div className="service-collage-trigger-oil hidden lg:block relative w-full h-[950px] mt-10 rounded-2xl border border-neutral-900 bg-neutral-950/40 overflow-hidden">
        ...
        <div className="absolute left-[3%] top-[4%] -translate-x-1/2 -translate-y-1/2 w-8 h-8 rounded-full border border-[#d946ef]/30 flex items-center justify-center pointer-events-none z-20">
          <div className="w-5 h-5 rounded-full border border-[#d946ef]/50 flex items-center justify-center animate-pulse">
            <span className="text-[10px] text-[#d946ef] font-mono leading-none">+</span>
          </div>
        </div>
        ...
        <div className="absolute left-[0.5%] top-24 w-4 flex justify-center pointer-events-none select-none z-20">
          <span className={`text-[8px] uppercase tracking-[0.25em] text-neutral-600 font-mono origin-top-left rotate-90 whitespace-nowrap border border-neutral-900 bg-neutral-950 px-2 py-0.5 ${shareTechMono.className}`}>
            [ DOSSIER: OIL_PAINTING_SPECIMEN // 05 ]
          </span>
        </div>

        {/* The 6 Collage Elements (Layout Classically Staggered) */}

        {/* ELEMENT 1 (Large Square, top-left) */}
        <motion.div
          style={{ y: yCollageSlow }}
          whileHover={{ scale: 1.03, zIndex: 25 }}
          transition={{ type: "spring", stiffness: 300, damping: 20 }}
          className="absolute top-[4%] left-[6%] w-[38%] aspect-[1.1/1] rounded-xl border border-neutral-900 overflow-hidden shadow-2xl bg-neutral-950 z-10 cursor-pointer"
        >
          <div className="absolute inset-0 bg-gradient-to-t from-black/95 via-black/40 to-transparent flex flex-col justify-end p-2 sm:p-4 md:p-6 z-20">
            <h4 className={`text-[10px] sm:text-lg md:text-2xl font-black text-[#d946ef] leading-none uppercase ${spaceGrotesk.className}`}>
              TRANSLUCENT GLAZES<br />
              LOCKING PIGMENTS<br />
              IN LINEN CELLS.
            </h4>
        ...
        {/* ELEMENT 2 (Medium Square, bottom-middle) */}
        <motion.div
          style={{ y: yCollageFast }}
          whileHover={{ scale: 1.03, zIndex: 25 }}
          transition={{ type: "spring", stiffness: 300, damping: 20 }}
          className="absolute bottom-[6%] left-[46%] w-[26%] aspect-square rounded-xl border-2 border-[#d946ef] overflow-hidden shadow-2xl bg-neutral-950 z-10 cursor-pointer"
        >
          <div className="absolute top-2 left-2 z-20 text-[6px] sm:text-[8px] font-mono text-[#d946ef] bg-black/85 px-1 sm:px-1.5 py-0.5 rounded border border-[#d946ef]/30">
            [ LIGHT_SCATTER // SPECIMEN_05 ]
          </div>
          <Image
            src={images[2]}
            alt="Oil Painting Specimen 2"
            fill
        ...
        {/* ELEMENT 3 (Small Scope, bottom-left) */}
        <motion.div
          style={{ y: yCollageFast }}
          whileHover={{ scale: 1.03, zIndex: 25 }}
          transition={{ type: "spring", stiffness: 300, damping: 20 }}
          className="absolute bottom-[8%] left-[10%] w-[16%] aspect-square rounded-xl border border-neutral-900 overflow-hidden shadow-2xl bg-neutral-950 z-10 cursor-pointer"
        >
          <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-20">
            <div className="w-[80%] h-[80%] rounded-full border border-[#d946ef]/30 border-dashed flex items-center justify-center">
              <div className="w-[60%] h-[60%] rounded-full border border-[#d946ef]/40 flex items-center justify-center">
        ...
        {/* ELEMENT 4 (Small Bright Colored, top-right) */}
        <motion.div
          style={{ y: yCollageSlow }}
          whileHover={{ scale: 1.03, zIndex: 25 }}
          transition={{ type: "spring", stiffness: 300, damping: 20 }}
          className="absolute top-[6%] left-[72%] w-[22%] aspect-square rounded-xl border-2 border-[#d946ef] overflow-hidden shadow-2xl bg-neutral-950 z-10 cursor-pointer"
        >
          {/* Red/Yellow duotone overlays */}
          <div className="absolute inset-0 bg-red-500 mix-blend-color z-10 pointer-events-none" />
          <div className="absolute inset-0 bg-yellow-600 mix-blend-multiply z-10 pointer-events-none" />
        ...
        {/* ELEMENT 5 (Small Detail, middle-right) */}
        <motion.div
          style={{ y: yCollageSlow }}
          whileHover={{ scale: 1.03, zIndex: 25 }}
          transition={{ type: "spring", stiffness: 300, damping: 20 }}
          className="absolute top-[38%] left-[72%] w-[20%] aspect-square rounded-xl border border-neutral-900 overflow-hidden shadow-2xl bg-neutral-950 z-10 cursor-pointer"
        >
          {/* Hexagonal honeycomb overlay */}
          ...
          <div className="absolute inset-0 flex items-center justify-center z-25 pointer-events-none">
            <div className="w-[85%] h-[85%] opacity-35 border border-dashed border-[#d946ef] rounded-lg rotate-45 flex items-center justify-center">
              <div className="w-[70%] h-[70%] border border-[#d946ef] rounded" />
            </div>
          </div>
          <Image
            src={images[1]}
            alt="Oil Painting Specimen 5"
            fill
        ...
        <motion.div
          ...
          whileHover={{ scale: 1.03, zIndex: 25 }}
          transition={{ type: "spring", stiffness: 300, damping: 20 }}
          className="absolute bottom-[4%] left-[6%] w-[36%] aspect-[1.2/1] rounded-xl border border-neutral-900 overflow-hidden shadow-2xl bg-neutral-950 z-10 cursor-pointer"
        >
          <div className="absolute inset-0 bg-gradient-to-r from-black/95 via-black/45 to-transparent flex items-center p-4 sm:p-8 z-20">
            <p className={`text-neutral-300 text-[8px] sm:text-xs md:text-sm max-w-[120px] sm:max-w-[220px] leading-relaxed font-mono ${shareTechMono.className}`}>
              Glazed oleoresin structure refracting wavelengths under microscopic examination.
            </p>
          </div>
          <div className={`absolute bottom-3 right-4 z-20 text-[6px] sm:text-[8px] font-mono text-neutral-500 uppercase tracking-widest ${shareTechMono.className}`}>
            OLEORESIN STRUCT // bernald
          </div>
          <Image
            src={images[3]}
            alt="Oil Painting Specimen 6"
            fill
            className="object-cover"
      ...
      <div className="lg:hidden block relative w-full mt-10 rounded-2xl border border-neutral-900 bg-neutral-950/40 p-4">
        ...
        <div className="grid grid-cols-2 gap-4 relative z-10">
          ...
          {/* CARD 1 (Row 1 Left) - Translucent glazes */}
          <motion.div
          ...
          >
            {/* Magenta dot indicator top-left */}
            <div className="absolute top-2.5 left-2.5 w-1.5 h-1.5 rounded-full bg-[#d946ef] z-20" />
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/95 via-black/40 to-transparent flex flex-col justify-end p-3 z-20">
              <h4 className={`text-[8px] sm:text-xs font-black text-[#d946ef] leading-none uppercase ${spaceGrotesk.className}`}>
                TRANSLUCENT GLAZES<br />
                LOCKING PIGMENTS<br />
                IN LINEN CELLS.
              </h4>
          ...
          {/* CARD 2 (Row 1 Right) - Light Scatter (with magenta border) */}
          <motion.div
            variants={cardVariants}
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true, margin: "-50px" }}
            custom={1}
            className="relative aspect-square rounded-xl border-2 border-[#d946ef] overflow-hidden bg-neutral-950"
          >
            <div className="absolute top-2 left-2 z-20 text-[6px] sm:text-[8px] font-mono text-[#d946ef] bg-black/85 px-1.5 py-0.5 rounded border border-[#d946ef]/30">
              [ LIGHT_SCATTER // SPECIMEN_05 ]
            </div>
            <Image
              src={images[2]}
          ...
          {/* CARD 3 (Row 2 Left) - Detail Target Scan (with circle overlay) */}
          <motion.div
            variants={cardVariants}
            initial="hidden"
            whileInView="visible"
          ...
          {/* CARD 4 (Row 2 Right) - Restore Classical (with magenta border) */}
          <motion.div
            variants={cardVariants}
            initial="hidden"
            whileInView="visible"
          ...
          {/* CARD 5 (Row 3 Left) - Hexagonal Honeycomb Details */}
          <motion.div
            variants={cardVariants}
            initial="hidden"
            whileInView="visible"
          ...
          {/* CARD 6 (Row 3 Right) - Oleoresin details */}
          <motion.div
            variants={cardVariants}
            initial="hidden"
            whileInView="visible"
