...
const SpectrumIcon = () => (
  <svg viewBox="0 0 100 100" className="w-8 h-8 text-[#ff9100]" fill="none" stroke="currentColor" strokeWidth="1.5">
    <polygon points="50,20 85,80 15,80" />
    <line x1="5" y1="60" x2="35" y2="50" stroke="white" />
    <line x1="60" y1="55" x2="95" y2="40" stroke="#ff9100" />
    <line x1="63" y1="58" x2="95" y2="50" stroke="#ff3d00" />
    <line x1="66" y1="62" x2="95" y2="60" stroke="#ffc400" />
  </svg>
);

export default function ColourPencil() {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      gsap.fromTo(
        ".service-collage-trigger-color .cursor-pointer",
        { scale: 0.9, opacity: 0, y: 30 },
        {
          ...
          ease: "back.out(1.2)",
          scrollTrigger: {
            trigger: ".service-collage-trigger-color",
            start: "top 80%",
          }
        }
      );
  ...
  const images = [
    "/images/services/colored_pencil_1.jpg",
    "/images/services/colored_pencil_2.png",
    "/images/services/colored_pencil_3.png",
    "/images/services/colored_pencil_4.png",
  ];
  ...
  return (
    ...
    >
      ...
      <div className="grid lg:grid-cols-12 gap-8 md:gap-12 items-start mb-16 relative z-10 w-full">
        ...
        <div className="service-panel-left lg:col-span-4 flex flex-col gap-4">
          <div className="relative w-full aspect-[16/10] rounded-lg overflow-hidden border border-neutral-900 bg-neutral-950/60">
            {/* Tag overlay */}
            <div className="absolute top-0 left-0 bg-[#ff9100] text-black px-2.5 py-1 font-bold text-xs z-20">
              03
            </div>
            ...
            {/* Bottom label */}
            <div className={`absolute bottom-0 left-0 right-0 bg-black/85 text-[8px] text-[#ff9100] font-mono px-3 py-1 flex items-center justify-between border-t border-neutral-900 z-10 ${shareTechMono.className}`}>
              <span>&lt; SPECTRUM_ACTIVE &gt;</span>
              <span>SYS_OK</span>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between gap-6">
            <div className="flex-1 space-y-1.5">
              <div className="flex items-center gap-3">
                <span className={`px-2 py-0.5 text-[8px] font-bold text-black bg-[#ff9100] uppercase tracking-wider rounded ${shareTechMono.className}`}>
                  SUBSTRATE
                </span>
                <span className={`text-[10px] text-neutral-400 font-mono tracking-wider ${shareTechMono.className}`}>
                  ARCHIVAL COTTON PRESS 300G
                </span>
              </div>
              <div className="flex items-center gap-3">
                <span className={`px-2 py-0.5 text-[8px] font-bold text-black bg-[#ff9100] uppercase tracking-wider rounded ${shareTechMono.className}`}>
        ...
        >
          <h3 className={`text-4xl md:text-6xl font-black uppercase tracking-tight text-white ${spaceGrotesk.className}`}>
            Colour <span className={`${elsie.className} text-[#ff9100] lowercase tracking-normal font-normal px-1`}>pencil</span>
          </h3>

          <div className={`text-xs md:text-sm font-bold text-[#ff9100] uppercase tracking-widest mt-1 ${shareTechMono.className}`}>
            CHROMATIC LAYER SYNTHESIS & WAX-CORE MATRIX
          </div>
          ...
          <div className={`flex items-center gap-2 text-[10px] text-neutral-800 tracking-wider font-mono select-none my-4 w-full overflow-hidden ${shareTechMono.className}`}>
            ...
            <span className="text-[#ff9100] flex-shrink-0">+</span>
          </div>
          ...
          <div className="grid md:grid-cols-12 gap-6 items-center">
            ...
            <div className="md:col-span-4 flex w-full justify-center md:justify-end">
              <a
                href="#contact"
                onClick={() => {
                  window.dispatchEvent(new CustomEvent("select-art-type", { detail: "Colour Pencil" }));
                }}
                className={`group w-full md:max-w-[200px] py-4 rounded-full border-2 border-[#ff9100] text-center text-xs font-bold uppercase tracking-[0.2em] transition-all duration-300 hover:bg-[#ff9100]/10 text-[#ff9100] hover:text-white ${shareTechMono.className}`}
              >
                Learn More
              </a>
            </div>
      ...
      <div className="service-collage-trigger-color hidden lg:block relative w-full h-[950px] mt-10 rounded-2xl border border-neutral-900 bg-neutral-950/40 overflow-hidden">
        ...
        <div className="absolute left-[3%] top-[4%] -translate-x-1/2 -translate-y-1/2 w-8 h-8 rounded-full border border-[#ff9100]/30 flex items-center justify-center pointer-events-none z-20">
          <div className="w-5 h-5 rounded-full border border-[#ff9100]/50 flex items-center justify-center animate-pulse">
            <span className="text-[10px] text-[#ff9100] font-mono leading-none">+</span>
          </div>
        </div>
        ...
        <div className="absolute left-[0.5%] top-24 w-4 flex justify-center pointer-events-none select-none z-20">
          <span className={`text-[8px] uppercase tracking-[0.25em] text-neutral-600 font-mono origin-top-left rotate-90 whitespace-nowrap border border-neutral-900 bg-neutral-950 px-2 py-0.5 ${shareTechMono.className}`}>
            [ DOSSIER: COLOUR_PENCIL_SPECIMEN // 03 ]
          </span>
        </div>
        ...
        >
          <div className="absolute inset-0 bg-gradient-to-t from-black/95 via-black/40 to-transparent flex flex-col justify-end p-2 sm:p-4 md:p-6 z-20">
            <h4 className={`text-[10px] sm:text-lg md:text-2xl font-black text-[#ff9100] leading-none uppercase ${spaceGrotesk.className}`}>
              CHROMATIC LAYER<br />
              SYNTHESIS WAX-CORES<br />
              ON COTTON MATRIX.
            </h4>
            <span className={`text-[6px] sm:text-[9px] uppercase tracking-widest text-neutral-400 mt-1 sm:mt-2 font-mono ${shareTechMono.className}`}>
              colossal / spectrum_03
            </span>
          </div>
          <Image
            src={images[0]}
            alt="Colour Pencil Specimen 1"
            fill
            className="object-cover"
        ...
        {/* ELEMENT 2 (Medium Square, top-left) */}
        <motion.div
          style={{ y: yCollageFast }}
          whileHover={{ scale: 1.03, zIndex: 25 }}
          transition={{ type: "spring", stiffness: 300, damping: 20 }}
          className="absolute top-[3%] left-[6%] w-[26%] aspect-square rounded-xl border-2 border-[#ff9100] overflow-hidden shadow-2xl bg-neutral-950 z-10 cursor-pointer"
        >
          <div className="absolute top-2 left-2 z-20 text-[6px] sm:text-[8px] font-mono text-[#ff9100] bg-black/85 px-1 sm:px-1.5 py-0.5 rounded border border-[#ff9100]/30">
            [ SPECTRUM_MAP // SPECIMEN_03 ]
          </div>
          <Image
            src={images[1]}
            alt="Colour Pencil Specimen 2"
            fill
        ...
        {/* ELEMENT 3 (Small Scope, top-middle) */}
        <motion.div
          style={{ y: yCollageFast }}
          whileHover={{ scale: 1.03, zIndex: 25 }}
          transition={{ type: "spring", stiffness: 300, damping: 20 }}
          className="absolute top-[5%] left-[36%] w-[16%] aspect-square rounded-xl border border-neutral-900 overflow-hidden shadow-2xl bg-neutral-950 z-10 cursor-pointer"
        >
          <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-20">
            <div className="w-[80%] h-[80%] rounded-full border border-[#ff9100]/30 border-dashed flex items-center justify-center">
              <div className="w-[60%] h-[60%] rounded-full border border-[#ff9100]/40 flex items-center justify-center">
        ...
        <motion.div
          ...
          whileHover={{ scale: 1.03, zIndex: 25 }}
          transition={{ type: "spring", stiffness: 300, damping: 20 }}
          className="absolute bottom-[5%] left-[34%] w-[20%] aspect-square rounded-xl border-2 border-[#ff9100] overflow-hidden shadow-2xl bg-neutral-950 z-10 cursor-pointer"
        >
          {/* Teal/Blue duotone overlays */}
          <div className="absolute inset-0 bg-teal-500 mix-blend-color z-10 pointer-events-none" />
          <div className="absolute inset-0 bg-blue-700 mix-blend-multiply z-10 pointer-events-none" />
        ...
        {/* ELEMENT 5 (Small Detail, bottom-left) */}
        <motion.div
          style={{ y: yCollageSlow }}
          whileHover={{ scale: 1.03, zIndex: 25 }}
          transition={{ type: "spring", stiffness: 300, damping: 20 }}
          className="absolute bottom-[5%] left-[8%] w-[22%] aspect-square rounded-xl border border-neutral-900 overflow-hidden shadow-2xl bg-neutral-950 z-10 cursor-pointer"
        >
          ...
          <div className="absolute inset-0 flex items-center justify-center z-25 pointer-events-none">
            <div className="w-[80%] h-[80%] opacity-40 border border-dashed border-white flex flex-col justify-between p-1">
              <div className="border-b border-white border-dashed w-full h-[1px]" />
              <div className="border-b border-white border-dashed w-full h-[1px]" />
              <div className="border-b border-white border-dashed w-full h-[1px]" />
            </div>
          </div>
        ...
        <motion.div
          ...
          whileHover={{ scale: 1.03, zIndex: 25 }}
          transition={{ type: "spring", stiffness: 300, damping: 20 }}
          className="absolute bottom-[3%] left-[58%] w-[38%] aspect-[1.2/1] rounded-xl border border-neutral-900 overflow-hidden shadow-2xl bg-neutral-950 z-10 cursor-pointer"
        >
          <div className="absolute inset-0 bg-gradient-to-r from-black/95 via-black/45 to-transparent flex items-center p-4 sm:p-8 z-20">
            <p className={`text-neutral-300 text-[8px] sm:text-xs md:text-sm max-w-[120px] sm:max-w-[220px] leading-relaxed font-mono ${shareTechMono.className}`}>
              Micro-layered burnished substrate observing pigment core composition under refraction scanning.
            </p>
          </div>
          <div className={`absolute bottom-3 right-4 z-20 text-[6px] sm:text-[8px] font-mono text-neutral-500 uppercase tracking-widest ${shareTechMono.className}`}>
            WAX-CORE TECHNOLOGY // bernald
          </div>
          <Image
            src={images[2]}
            alt="Colour Pencil Specimen 6"
            fill
            className="object-cover"
      ...
      <div className="lg:hidden block relative w-full mt-10 rounded-2xl border border-neutral-900 bg-neutral-950/40 p-4">
        ...
        <div className="grid grid-cols-2 gap-4 relative z-10">
          ...
          {/* CARD 1 (Row 1 Left) - Chromatic depth */}
          <motion.div
          ...
          >
            {/* Orange dot indicator top-left */}
            <div className="absolute top-2.5 left-2.5 w-1.5 h-1.5 rounded-full bg-[#ff9100] z-20" />
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/95 via-black/45 to-transparent flex flex-col justify-end p-3 z-20">
              <h4 className={`text-[8px] sm:text-xs font-black text-[#ff9100] leading-none uppercase ${spaceGrotesk.className}`}>
                CHROMATIC DEPTH<br />
                BURNISHED INTO<br />
                BRISTOL GRAIN.
              </h4>
              <span className={`text-[5px] sm:text-[7px] uppercase tracking-widest text-neutral-400 mt-1 font-mono ${shareTechMono.className}`}>
                colossal / chromatic_03
              </span>
            </div>
            <Image
              src={images[0]}
          ...
          {/* CARD 2 (Row 1 Right) - Spectrum Map (with orange border) */}
          <motion.div
            variants={cardVariants}
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true, margin: "-50px" }}
            custom={1}
            className="relative aspect-square rounded-xl border-2 border-[#ff9100] overflow-hidden bg-neutral-950"
          >
            <div className="absolute top-2 left-2 z-20 text-[6px] sm:text-[8px] font-mono text-[#ff9100] bg-black/85 px-1.5 py-0.5 rounded border border-[#ff9100]/30">
              [ SPECTRUM_MAP // SPECIMEN_03 ]
            </div>
            <Image
              src={images[1]}
          ...
          {/* CARD 4 (Row 2 Right) - Concept Mapped (with orange border) */}
          <motion.div
            variants={cardVariants}
            initial="hidden"
            whileInView="visible"
          ...
          {/* CARD 5 (Row 3 Left) - Crosshatch Grid Overlay */}
          <motion.div
            variants={cardVariants}
            initial="hidden"
            whileInView="visible"
          ...
          {/* CARD 6 (Row 3 Right) - Wax Core details */}
          <motion.div
            variants={cardVariants}
            initial="hidden"
            whileInView="visible"
