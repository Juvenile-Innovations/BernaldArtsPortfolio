...
const SpatialCubeIcon = () => (
  <svg viewBox="0 0 100 100" className="w-8 h-8 text-[#9eff00]" fill="none" stroke="currentColor" strokeWidth="1.5">
    ...
    <line x1="20" y1="67.5" x2="50" y2="50" strokeDasharray="3 3" />
    <line x1="80" y1="67.5" x2="50" y2="50" strokeDasharray="3 3" />
  </svg>
);
...
export default function WallArt() {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      gsap.fromTo(
        ".service-collage-trigger-wall .cursor-pointer",
        { scale: 0.9, opacity: 0, y: 30 },
        {
          ...
          ease: "back.out(1.2)",
          scrollTrigger: {
            trigger: ".service-collage-trigger-wall",
            start: "top 80%",
          }
        }
      );
  ...
  const images = [
    "/images/services/wall_art_1.jpg",
    "/images/services/wall_art_2.jpg",
    "/images/services/wall_art_3.jpg",
    "/images/services/wall_art_4.jpg",
    "/images/services/wall_art_5.jpg",
  ];
  ...
  return (
    ...
    >
      ...
      <div className="grid lg:grid-cols-12 gap-8 md:gap-12 items-start mb-16 relative z-10 w-full">
        ...
        <div className="lg:col-span-4 flex flex-col gap-4">
          <div className="relative w-full aspect-[16/10] rounded-lg overflow-hidden border border-neutral-900 bg-neutral-950/60">
            {/* Tag overlay */}
            <div className="absolute top-0 left-0 bg-[#9eff00] text-black px-2.5 py-1 font-bold text-xs z-20">
              01
            </div>
            ...
            {/* Bottom label */}
            <div className={`absolute bottom-0 left-0 right-0 bg-black/85 text-[8px] text-[#9eff00] font-mono px-3 py-1 flex items-center justify-between border-t border-neutral-900 z-10 ${shareTechMono.className}`}>
          ...
          <div className="flex items-center justify-between gap-6">
            <div className="flex-1 space-y-1.5">
              <div className="flex items-center gap-3">
                <span className={`px-2 py-0.5 text-[8px] font-bold text-black bg-[#9eff00] uppercase tracking-wider rounded ${shareTechMono.className}`}>
                  SUBSTRATE
                </span>
        ...
        <motion.div
          style={{ y: yText }}
          className="lg:col-span-8 flex flex-col justify-start w-full min-w-0"
        >
          <h3 className={`text-4xl md:text-6xl font-black uppercase tracking-tight text-white ${spaceGrotesk.className}`}>
            Wall <span className={`${elsie.className} text-[#9eff00] lowercase tracking-normal font-normal px-1`}>art</span>
          </h3>

          <div className={`text-xs md:text-sm font-bold text-[#9eff00] uppercase tracking-widest mt-1 ${shareTechMono.className}`}>
            AEROSOL & SPATIAL MURAL INTEGRATION
          </div>
          ...
          <div className={`flex items-center gap-2 text-[10px] text-neutral-800 tracking-wider font-mono select-none my-4 w-full overflow-hidden ${shareTechMono.className}`}>
            ...
            <span className="text-[#9eff00] flex-shrink-0">+</span>
          </div>
          ...
          <div className="grid md:grid-cols-12 gap-6 items-center">
            ...
            <div className="md:col-span-4 flex w-full justify-center md:justify-end">
              <a
                href="#contact"
                onClick={() => {
                  window.dispatchEvent(new CustomEvent("select-art-type", { detail: "Wall Art" }));
                }}
                className={`group w-full md:max-w-[200px] py-4 rounded-full border-2 border-[#9eff00] text-center text-xs font-bold uppercase tracking-[0.2em] transition-all duration-300 hover:bg-[#9eff00]/10 text-[#9eff00] hover:text-white ${shareTechMono.className}`}
              >
                BOOK NOW
              </a>
            </div>
      ...
      <div className="service-collage-trigger-wall hidden lg:block relative w-full h-[950px] mt-10 rounded-2xl border border-neutral-900 bg-neutral-950/40 overflow-hidden">
        ...
        <div className="absolute left-[3%] top-[4%] -translate-x-1/2 -translate-y-1/2 w-8 h-8 rounded-full border border-[#9eff00]/30 flex items-center justify-center pointer-events-none z-20">
          <div className="w-5 h-5 rounded-full border border-[#9eff00]/50 flex items-center justify-center animate-pulse">
            <span className="text-[10px] text-[#9eff00] font-mono leading-none">+</span>
          </div>
        </div>
        ...
        >
          <div className="absolute inset-0 bg-gradient-to-t from-black/95 via-black/40 to-transparent flex flex-col justify-end p-2 sm:p-4 md:p-6 z-20">
            <h4 className={`text-[10px] sm:text-lg md:text-2xl font-black text-[#9eff00] leading-none uppercase ${spaceGrotesk.className}`}>
              ARCHITECTURAL<br />
            ...
            <span className={`text-[6px] sm:text-[9px] uppercase tracking-widest text-neutral-400 mt-1 sm:mt-2 font-mono ${shareTechMono.className}`}>
              colossal / vertical_01
            </span>
          </div>
          <Image
            src={images[4]}
            alt="Wall Art Specimen 1"
            fill
            className="object-cover"
        ...
        <motion.div
          ...
          whileHover={{ scale: 1.03, zIndex: 25 }}
          transition={{ type: "spring", stiffness: 300, damping: 20 }}
          className="absolute top-[3%] left-[45%] w-[26%] aspect-square rounded-xl border-2 border-[#9eff00] overflow-hidden shadow-2xl bg-neutral-950 z-10 cursor-pointer"
        >
          <div className="absolute top-2 left-2 z-20 text-[6px] sm:text-[8px] font-mono text-[#9eff00] bg-black/85 px-1 sm:px-1.5 py-0.5 rounded border border-[#9eff00]/30">
            [ STRUCTURAL_MAP // SPECIMEN_01 ]
          </div>
          <Image
            src={images[3]}
            alt="Wall Art Specimen 2"
            fill
        ...
        >
          <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-20">
            <div className="w-[80%] h-[80%] rounded-full border border-[#9eff00]/30 border-dashed flex items-center justify-center">
              <div className="w-[60%] h-[60%] rounded-full border border-[#9eff00]/40 flex items-center justify-center">
                <div className="w-1.5 h-1.5 rounded-full bg-[#9eff00]" />
              </div>
            </div>
          </div>
        ...
        <motion.div
          ...
          whileHover={{ scale: 1.03, zIndex: 25 }}
          transition={{ type: "spring", stiffness: 300, damping: 20 }}
          className="absolute bottom-[5%] left-[6%] w-[20%] aspect-square rounded-xl border-2 border-[#9eff00] overflow-hidden shadow-2xl bg-neutral-950 z-10 cursor-pointer"
        >
          ...
          <div className="absolute inset-0 flex items-center justify-center z-25 pointer-events-none">
            <div className="grid grid-cols-4 gap-1.5 w-[75%] h-[75%] opacity-45">
              {Array.from({ length: 16 }).map((_, i) => (
                <div key={i} className="w-2.5 h-2.5 sm:w-3.5 sm:h-3.5 rounded-full border border-[#9eff00]" />
              ))}
            </div>
          </div>
          <Image
            src={images[2]}
            alt="Wall Art Specimen 5"
            fill
        ...
        >
          <div className="absolute inset-0 bg-gradient-to-r from-black/95 via-black/45 to-transparent flex items-center p-4 sm:p-8 z-20">
            <p className={`text-neutral-300 text-[8px] sm:text-xs md:text-sm max-w-[120px] sm:max-w-[220px] leading-relaxed font-mono ${shareTechMono.className}`}>
              Dr. Bernald observing ancient spatial surfaces along concrete vertical structures in the urban landscape.
            </p>
          </div>
          <div className={`absolute bottom-3 right-4 z-20 text-[6px] sm:text-[8px] font-mono text-neutral-500 uppercase tracking-widest ${shareTechMono.className}`}>
            DEEP-POLYMER TECHNOLOGY // bernald
          </div>
          <Image
            src={images[0]}
            alt="Wall Art Specimen 6"
            fill
            className="object-cover"
      ...
      <div className="lg:hidden block relative w-full mt-10 rounded-2xl border border-neutral-900 bg-neutral-950/40 p-4">
        ...
        <div className="grid grid-cols-2 gap-4 relative z-10">
          ...
          {/* CARD 1 (Row 1 Left) - Architectural integration */}
          <motion.div
          ...
          >
            ...
            <div className="absolute top-2.5 left-2.5 w-1.5 h-1.5 rounded-full bg-[#9eff00] z-20" />
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/95 via-black/40 to-transparent flex flex-col justify-end p-3 z-20">
              <h4 className={`text-[8px] sm:text-xs font-black text-[#9eff00] leading-none uppercase ${spaceGrotesk.className}`}>
                ARCHITECTURAL<br />
                INTEGRATION BUILT<br />
                UPON SPATIAL MATRIX.
              </h4>
          ...
          {/* CARD 2 (Row 1 Right) - Elephant Illustration (with lime border) */}
          <motion.div
            variants={cardVariants}
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true, margin: "-50px" }}
            custom={1}
            className="relative aspect-square rounded-xl border-2 border-[#9eff00] overflow-hidden bg-neutral-950"
          >
            <div className="absolute top-2 left-2 z-20 text-[6px] sm:text-[8px] font-mono text-[#9eff00] bg-black/85 px-1.5 py-0.5 rounded border border-[#9eff00]/30">
              [ STRUCTURAL_MAP // SPECIMEN_01 ]
            </div>
            <Image
              src={images[3]}
          ...
          {/* CARD 4 (Row 2 Right) - Pink/Orange Concept Mapped (with lime border) */}
          <motion.div
            variants={cardVariants}
            initial="hidden"
            whileInView="visible"
          ...
          >
            ...
            <div className="absolute inset-0 flex items-center justify-center z-20 pointer-events-none">
              <div className="grid grid-cols-4 gap-1.5 w-[75%] h-[75%] opacity-45">
                {Array.from({ length: 16 }).map((_, i) => (
                  <div key={i} className="w-2 h-2 sm:w-3 sm:h-3 rounded-full border border-[#9eff00]" />
                ))}
              </div>
            </div>
            <Image
          ...
          {/* CARD 6 (Row 3 Right) - Dr. Bernald Observing */}
          <motion.div
            variants={cardVariants}
            initial="hidden"
            whileInView="visible"
